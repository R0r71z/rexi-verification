...
def BuscarInformacion(clave,donde):
    ...
    if clave == "vencimiento_de_unidades":
        if ("punto" in donde or "abonapunto" in donde or "milla " in donde or "bono" in donde or "llave" in donde or "estrella" in donde or "pasos" in donde or "manos" in donde):
